...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        ##### loss control
        self.use_brightness_control = True
        self.explicitly_update_brightness_control = True
        self.ssim_loss_use = True
        self.use_foreground_background_loss = True
        self.use_penal_large_gaussians = True
        self.use_penal_spiky_gaussians = True
        self.use_motion_grad = False
        self.use_depth_smoothness_loss = True
        ...
        self.eval_include_train_cams = True
        self.downscale_mask_deform_lr = 0.1
        self.SH_lr_downscaling_start = 8
        self.SH_lr_downscaling_end = 20
        self.make_foreground_thresh_larger =False
        self.make_background_thresh_larger =True
